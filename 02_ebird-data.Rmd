...
If you don't have enough hard drive space to store the full eBird data set, which is more than 200GB, or don't have a fast enough internet connection to download it, consult the section on [using the Custom Download form](#ebird-size-custom) for an alternative approach to filtering eBird data.
